...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <form name="registrieren" onsubmit="return checkformular()" action="registrierenbestaetigung.php" method="post">
                <table>
                    <tr>
                        <td>Name*</td>
                ...
                <button type="submit" >Kostenpflichtig Registrieren</button><br><br>
                <p>* Pflichtfelder</p>
            </form>
        </main>
